...
set COMMANDLINE_ARGS=%COMMANDLINE_ARGS% --precision full --no-half --no-half-vae --disable-nan-check

echo Configuration: Full FP32 precision test
echo Arguments: --precision full --no-half --no-half-vae --disable-nan-check
echo.
