@echo off
echo VAE Test: Try MSE VAE (different training)
echo ========================================
echo.
...
set COMMANDLINE_ARGS=%COMMANDLINE_ARGS% --vae-path "models/VAE/vae-ft-mse-840000-ema-pruned.ckpt"

echo Configuration: Try MSE VAE (different training)
echo VAE Args: --vae-path "models/VAE/vae-ft-mse-840000-ema-pruned.ckpt"
